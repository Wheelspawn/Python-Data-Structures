...
class Neuron():
    ...
    def feedForward(self, WeightList, inputList, bias): # sums all input*weight. 1 bias input. Calculates activation function. Returns summation.
